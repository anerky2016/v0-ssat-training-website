...
import absoluteValueData from "@/data/integers-absolute-value.json"
...
export default function IntegersAbsoluteValuePage() {
  ...
  const exercisesByDifficulty = {
    easy: absoluteValueData.exercises.easy || [],
    medium: absoluteValueData.exercises.medium || [],
    challenge: absoluteValueData.exercises.challenge || [],
    extreme: absoluteValueData.exercises.extreme || [],
  }
  ...
  return (
    <MathJaxContext>
      ...
      <main>
        {/* Hero Section */}
        <section className="py-4 sm:py-6 lg:py-8 bg-gradient-to-b from-chart-11/5 to-background">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-foreground mb-4">
                {absoluteValueData.topic}
              </h1>
              <p className="text-lg text-muted-foreground mb-4">
                <strong>Audience:</strong> {absoluteValueData.audience}
              </p>
              <p className="text-base text-muted-foreground mb-6">
                {absoluteValueData.summary}
              </p>
              <CompleteStudyButton category="math" topicTitle={absoluteValueData.topic} />
            </div>
          </div>
        </section>

        {/* Concepts Sections */}
        {absoluteValueData.concepts.map((concept, index) => (
        ...
        {/* Teaching Tips */}
        {absoluteValueData.teaching_tips && absoluteValueData.teaching_tips.length > 0 && (
                ...
                <Card className="border-chart-5/20">
                  <CardContent className="pt-6">
                    <ul className="space-y-3">
                      {absoluteValueData.teaching_tips.map((tip, idx) => (
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="space-y-4">
                {absoluteValueData.worked_examples.map((example, idx) => (
            ...
            <div className="mx-auto max-w-4xl">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                ...
                <PrintExercisesButton
                  ...
                  topicTitle={absoluteValueData.topic}
            ...
            <div className="mx-auto max-w-4xl">
              <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-chart-8/5">
                <CardContent className="pt-8 pb-8 text-center">
                  ...
                  <CompleteStudyButton category="math" topicTitle={absoluteValueData.topic} centered size="lg" />
                </CardContent>
              </Card>
            </div>
          </div>
