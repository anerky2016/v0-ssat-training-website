          ...
          <section className="py-4 sm:py-6 lg:py-8 bg-gradient-to-b from-chart-8/5 to-background">
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <CompleteStudyButton category="math" topicTitle={evaluatingTwoData.title} />
              </div>
            </div>
          </section>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="space-y-3">
                          <label className="flex items-start gap-3 cursor-pointer group">
                            ...
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">I understand how to evaluate expressions with two variables</span>
                          </label>
                          <label className="flex items-start gap-3 cursor-pointer group">
                            ...
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">I know how to substitute both values and follow order of operations</span>
                          </label>
                          <label className="flex items-start gap-3 cursor-pointer group">
              ...
              <div className="mx-auto max-w-4xl">
                <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-chart-8/5">
                  <CardContent className="pt-8 pb-8 text-center">
                    ...
                    <CompleteStudyButton category="math" topicTitle={evaluatingTwoData.title} centered size="lg" />
                  </CardContent>
                </Card>
              </div>
            </div>
