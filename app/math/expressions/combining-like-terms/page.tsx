                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          ...
                          Taking just <strong className="text-foreground">4 minutes</strong> to understand these concepts will save you 30+ minutes of frustration later!
                        </p>
                      </div>
                    </div>
                  </CardContent>
                        ...
                        <div className="space-y-3">
                          <label className="flex items-start gap-3 cursor-pointer group">
                            ...
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                              I understand what "like terms" means and how to identify them
                            </span>
                          </label>
                          <label className="flex items-start gap-3 cursor-pointer group">
                            <input
                            ...
                            />
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                              I know how to combine coefficients while keeping the variable part unchanged
                            </span>
                          </label>
                          <label className="flex items-start gap-3 cursor-pointer group">
                            <input
