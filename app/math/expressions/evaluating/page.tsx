...
import evaluatingData from "@/data/evaluating-one-variable.json"
...
export default function EvaluatingOneVariablePage() {
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-foreground mb-4">
                  {evaluatingData.title}
                </h1>
                <p className="text-lg text-muted-foreground mb-6">
                  <strong>Audience:</strong> {evaluatingData.audience}
                </p>
                <CompleteStudyButton category="math" topicTitle={evaluatingData.title} />
              </div>
            </div>
          </section>
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl sm:text-3xl font-bold text-foreground">Understanding Evaluating Expressions</h2>
                ...
                <div className="grid gap-4">
                  {evaluatingData.kid_friendly_explainer.map((explanation, index) => (
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-6">
                  {evaluatingData.core_rules.map((rule, index) => (
                        ...
                        <div className="space-y-3">
                          <label className="flex items-start gap-3 cursor-pointer group">
                            ...
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                              I understand what it means to "evaluate" an expression
                            </span>
                          </label>
                          <label className="flex items-start gap-3 cursor-pointer group">
                            <input
                            ...
                            />
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                              I know how to substitute values for variables and follow order of operations
                            </span>
                          </label>
                          <label className="flex items-start gap-3 cursor-pointer group">
                            <input
                            ...
                            />
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                              I'm ready to see how these rules work in practice
                            </span>
                          </label>
                        </div>
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  {evaluatingData.step_by_step_examples.map((example) => (
          ...
          <section className="py-12 sm:py-16 lg:py-20 bg-muted/30">
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-4">
                  {evaluatingData.teacher_notes.map((note, index) => (
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <p className="text-muted-foreground mb-6">
                  Master evaluating one-variable expressions with practice problems at different difficulty levels.
                </p>

                {/* Difficulty Selector and Print Button */}
                <div className="flex flex-wrap items-center gap-2 mb-8">
                  {Object.keys(evaluatingData.exercises).map((difficulty) => (
                    <Button
                      key={difficulty}
                  ...
                  {evaluatingData.exercises[selectedDifficulty as keyof typeof evaluatingData.exercises] && (
                    <PrintExercisesButton
                      exercises={evaluatingData.exercises[selectedDifficulty as keyof typeof evaluatingData.exercises].items}
                      topicTitle={evaluatingData.title}
                ...
                {evaluatingData.exercises[selectedDifficulty as keyof typeof evaluatingData.exercises] && (
                  <>
                    <Card className="mb-6 border-primary/20">
                      <CardContent className="pt-6">
                        <p className="text-sm text-muted-foreground">
                          <strong>Directions:</strong> <MathJax>{evaluatingData.exercises[selectedDifficulty as keyof typeof evaluatingData.exercises].directions}</MathJax>
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    <div className="space-y-4">
                      {evaluatingData.exercises[selectedDifficulty as keyof typeof evaluatingData.exercises].items.map((item) => (
              ...
              <div className="mx-auto max-w-4xl">
                <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-chart-8/5">
                  <CardContent className="pt-8 pb-8 text-center">
                    ...
                    <CompleteStudyButton category="math" topicTitle={evaluatingData.title} centered size="lg" />
                  </CardContent>
                </Card>
              </div>
            </div>
