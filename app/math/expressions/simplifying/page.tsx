...
import simplifyingData from "@/data/simplifying-expressions.json"
...
export default function SimplifyingExpressionsPage() {
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl sm:text-3xl font-bold text-foreground">Understanding Variable Expressions</h2>
                ...
                <div className="grid gap-4">
                  {simplifyingData.kid_friendly_explainer.map((explanation, index) => (
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-6">
                  {simplifyingData.core_rules.map((rule, index) => (
                        ...
                        <div className="space-y-3">
                          <label className="flex items-start gap-3 cursor-pointer group">
                            ...
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                              I understand what makes a term "like" or "unlike" with other terms
                            </span>
                          </label>
                          <label className="flex items-start gap-3 cursor-pointer group">
                            <input
                            ...
                            />
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                              I know which operations I can use when combining like terms
                            </span>
                          </label>
                          <label className="flex items-start gap-3 cursor-pointer group">
                            <input
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  {simplifyingData.step_by_step_examples.map((example) => (
          ...
          <section className="py-12 sm:py-16 lg:py-20 bg-muted/30">
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-4">
                  {simplifyingData.teacher_notes.map((note, index) => (
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <p className="text-muted-foreground mb-6">
                  Master simplifying variable expressions with practice problems at different difficulty levels.
                </p>

                {/* Difficulty Selector and Print Button */}
                <div className="flex flex-wrap items-center gap-2 mb-8">
                  {Object.keys(simplifyingData.exercises).map((difficulty) => (
                    <Button
                      key={difficulty}
                  ...
                  {simplifyingData.exercises[selectedDifficulty as keyof typeof simplifyingData.exercises] && (
                    <PrintExercisesButton
                      exercises={simplifyingData.exercises[selectedDifficulty as keyof typeof simplifyingData.exercises].items}
                      topicTitle={simplifyingData.title}
                ...
                {simplifyingData.exercises[selectedDifficulty as keyof typeof simplifyingData.exercises] && (
                  <>
                    <Card className="mb-6 border-primary/20">
                      <CardContent className="pt-6">
                        <p className="text-sm text-muted-foreground">
                          <strong>Directions:</strong> <MathJax>{simplifyingData.exercises[selectedDifficulty as keyof typeof simplifyingData.exercises].directions}</MathJax>
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    <div className="space-y-4">
                      {simplifyingData.exercises[selectedDifficulty as keyof typeof simplifyingData.exercises].items.map((item) => (
