...
import translatingData from "@/data/translating-phrases.json"
...
export default function TranslatingPhrasesPage() {
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          Students who read the Understanding and Keyword Guide sections carefully score <strong className="text-foreground">40% higher</strong> on practice problems.
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl sm:text-3xl font-bold text-foreground">Understanding Word-to-Math Translation</h2>
                ...
                <div className="grid gap-4">
                  {translatingData.kid_friendly_explainer.map((explanation, index) => (
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl sm:text-3xl font-bold text-foreground">Keyword Guide</h2>
                    <div className="flex items-center gap-2 mt-1">
                      <Clock className="h-4 w-4 text-muted-foreground" />
                ...
                <div className="grid gap-6">
                  {translatingData.core_rules.map((rule, index) => (
                      ...
                      <div className="flex-1">
                        ...
                        <div className="space-y-3">
                          <label className="flex items-start gap-3 cursor-pointer group">
                            ...
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">I understand how to translate word phrases into math expressions</span>
                          </label>
                          <label className="flex items-start gap-3 cursor-pointer group">
                            ...
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">I know the key operation words (sum, difference, product, quotient)</span>
                          </label>
                          <label className="flex items-start gap-3 cursor-pointer group">
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  {translatingData.step_by_step_examples.map((example) => (
          ...
          <section className="py-12 sm:py-16 lg:py-20 bg-muted/30">
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-4">
                  {translatingData.teacher_notes.map((note, index) => (
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <p className="text-muted-foreground mb-6">
                  Master translating word phrases into algebraic expressions with practice problems at different difficulty levels.
                </p>

                {/* Difficulty Selector and Print Button */}
                <div className="flex flex-wrap items-center gap-2 mb-8">
                  {Object.keys(translatingData.exercises).map((difficulty) => (
                    <Button
                      key={difficulty}
                  ...
                  {translatingData.exercises[selectedDifficulty as keyof typeof translatingData.exercises] && (
                    <PrintExercisesButton
                      exercises={translatingData.exercises[selectedDifficulty as keyof typeof translatingData.exercises].items}
                      topicTitle={translatingData.title}
                ...
                {translatingData.exercises[selectedDifficulty as keyof typeof translatingData.exercises] && (
                  <>
                    <Card className="mb-6 border-primary/20">
                      <CardContent className="pt-6">
                        <p className="text-sm text-muted-foreground">
                          <strong>Directions:</strong> <MathJax>{translatingData.exercises[selectedDifficulty as keyof typeof translatingData.exercises].directions}</MathJax>
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    <div className="space-y-4">
                      {translatingData.exercises[selectedDifficulty as keyof typeof translatingData.exercises].items.map((item) => (
