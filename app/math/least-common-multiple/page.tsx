...
import lcmData from "@/data/least-common-multiple.json"
import { MathJaxContext, MathJax } from 'better-react-mathjax'
import { PrintExercisesButton } from "@/components/print-exercises-button"

export default function LeastCommonMultiplePage() {
  ...
  const exercisesByDifficulty = {
    easy: lcmData.exercises.easy || [],
    medium: lcmData.exercises.medium || [],
    challenge: lcmData.exercises.challenge || [],
    extreme: lcmData.exercises.extreme || [],
  }
  ...
  return (
    <MathJaxContext>
      ...
      <main>
        {/* Hero Section */}
        <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-b from-chart-5/5 to-background">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <p className="text-lg text-muted-foreground mb-4">
                <strong>Audience:</strong> {lcmData.audience}
              </p>
        ...
        {/* Concepts Sections */}
        {lcmData.concepts.map((concept, index) => (
        ...
        {/* Teaching Tips */}
        {lcmData.teaching_tips && lcmData.teaching_tips.length > 0 && (
                ...
                <Card className="border-chart-5/20">
                  <CardContent className="pt-6">
                    <ul className="space-y-3">
                      {lcmData.teaching_tips.map((tip, idx) => (
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="space-y-4">
                {lcmData.worked_examples.map((example, idx) => (
