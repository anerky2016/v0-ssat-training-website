...
export default function CreateProportionPage() {
  ...
  const exercisesByDifficulty = {
    easy: proportionData.exercises.easy || [],
    medium: proportionData.exercises.medium || [],
    challenge: proportionData.exercises.challenge || [],
    extreme: proportionData.exercises.extreme || [],
  }
  ...
  return (
    <MathJaxContext>
      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-foreground mb-4">
                {proportionData.topic}
              </h1>
              <p className="text-lg text-muted-foreground mb-4">
                <strong>Audience:</strong> {proportionData.audience}
              </p>
        ...
        {/* Concepts Sections */}
        {proportionData.concepts.map((concept, index) => (
        ...
        {/* Teaching Tips */}
        {proportionData.teaching_tips && proportionData.teaching_tips.length > 0 && (
                ...
                <Card className="border-chart-5/20">
                  <CardContent className="pt-6">
                    <ul className="space-y-3">
                      {proportionData.teaching_tips.map((tip, idx) => (
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="space-y-4">
                {proportionData.worked_examples.map((example, idx) => (
