...
import factoringData from "@/data/factoring-numbers.json"
import { MathJaxContext, MathJax } from 'better-react-mathjax'
import { PrintExercisesButton } from "@/components/print-exercises-button"

export default function FactoringNumbersPage() {
  ...
  const exercisesByDifficulty = {
    easy: factoringData.exercises.easy || [],
    medium: factoringData.exercises.medium || [],
    challenge: factoringData.exercises.challenge || [],
    extreme: factoringData.exercises.extreme || [],
  }
  ...
  return (
    <MathJaxContext>
      ...
      <main>
        {/* Hero Section */}
        <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-b from-chart-3/5 to-background">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <p className="text-lg text-muted-foreground mb-4">
                <strong>Audience:</strong> {factoringData.audience}
              </p>
              <p className="text-base text-muted-foreground">
                {factoringData.summary}
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Concepts Sections */}
        {factoringData.concepts.map((concept, index) => (
          <section key={index} className={`py-12 sm:py-16 lg:py-20 ${index % 2 === 1 ? 'bg-muted/30' : ''}`}>
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                {/* Examples */}
                {concept.examples && (
                  <Card className="mb-6 border-chart-3/20">
                    <CardHeader>
                    ...
                    <CardContent>
                      <p className="text-sm text-muted-foreground">
                        <MathJax>{concept.examples}</MathJax>
                      </p>
                    </CardContent>
                  </Card>
                )}
        ...
        {/* Teaching Tips */}
        {factoringData.teaching_tips && factoringData.teaching_tips.length > 0 && (
                ...
                <Card className="border-chart-5/20">
                  <CardContent className="pt-6">
                    <ul className="space-y-3">
                      {factoringData.teaching_tips.map((tip, idx) => (
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="space-y-4">
                {factoringData.worked_examples.map((example, idx) => (
                      ...
                      <div className="space-y-4">
                        ...
                        {example.latex && (
                          <div className="bg-primary/10 rounded-lg p-4 overflow-x-auto">
                            <p className="text-sm font-semibold mb-2">Prime Factorization:</p>
            ...
            <div className="mx-auto max-w-4xl">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                ...
                <PrintExercisesButton
                  ...
                  topicTitle={factoringData.topic}
