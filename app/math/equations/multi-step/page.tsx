...
import multiStepData from "@/data/multi-step-equations.json"
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  <strong>Audience:</strong> {multiStepData.audience}
                </p>
                <CompleteStudyButton category="math" topicTitle={multiStepData.title} />
              </div>
            </div>
          </section>
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl sm:text-3xl font-bold text-foreground">Understanding Multi-Step Equations</h2>
                ...
                <div className="grid gap-4">
                  {multiStepData.kid_friendly_explainer.map((explanation, index) => (
              ...
              <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-6">
                  <Card className="border-chart-3/20">
                    <CardHeader>
                      <CardTitle className="text-xl text-primary">The Big Idea</CardTitle>
                      <CardDescription className="text-base">
                        <MathJax>{multiStepData.concept.big_idea}</MathJax>
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-4">
                        <div className="bg-muted/50 rounded-lg p-4">
                          <p className="text-sm text-muted-foreground">
                            <MathJax>{multiStepData.concept.why_it_works_kid_friendly}</MathJax>
                          </p>
                        </div>
                      </div>
                    </CardContent>
                  ...
                  <Card className="border-chart-3/20">
                    ...
                    <CardContent>
                      <ul className="space-y-3">
                        {multiStepData.key_points.map((point, idx) => (
                  ...
                  <Card className="border-chart-3/20">
                    ...
                    <CardContent>
                      <ol className="space-y-3">
                        {multiStepData.step_by_step.map((step, idx) => (
                          <li key={idx} className="flex items-start gap-3">
                        ...
                        <div className="space-y-3">
                          <label className="flex items-start gap-3 cursor-pointer group">
                            ...
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                              I understand how to distribute and combine like terms before solving
                            </span>
                          </label>
                          <label className="flex items-start gap-3 cursor-pointer group">
                            <input
                            ...
                            />
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                              I know how to move all variables to one side and constants to the other
                            </span>
                          </label>
                          <label className="flex items-start gap-3 cursor-pointer group">
                            <input
                            ...
                            />
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                              I'm ready to see how these steps work together in practice
                            </span>
                          </label>
                        </div>
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  {multiStepData.step_by_step_examples.map((example) => (
          ...
          <section className="py-12 sm:py-16 lg:py-20 bg-muted/30">
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-4">
                  {multiStepData.teacher_notes.map((note, index) => (
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <p className="text-muted-foreground mb-6">
                  Master multi-step equations with practice problems at different difficulty levels.
                </p>

                {/* Difficulty Selector and Print Button */}
                <div className="flex flex-wrap items-center gap-2 mb-8">
                  {Object.keys(multiStepData.exercises).map((difficulty) => (
                    <Button
                      key={difficulty}
                  ...
                  {multiStepData.exercises[selectedDifficulty as keyof typeof multiStepData.exercises] && (
                    <PrintExercisesButton
                      exercises={multiStepData.exercises[selectedDifficulty as keyof typeof multiStepData.exercises].items}
                      topicTitle={multiStepData.title}
                ...
                {multiStepData.exercises[selectedDifficulty as keyof typeof multiStepData.exercises] && (
                  <>
                    <Card className="mb-6 border-primary/20">
                      <CardContent className="pt-6">
                        <p className="text-sm text-muted-foreground">
                          <strong>Directions:</strong> <MathJax>{multiStepData.exercises[selectedDifficulty as keyof typeof multiStepData.exercises].directions}</MathJax>
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    {/* Practice Items */}
                    <div className="space-y-4">
                      {multiStepData.exercises[selectedDifficulty as keyof typeof multiStepData.exercises].items.map((item) => (
              ...
              <div className="mx-auto max-w-4xl">
                <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-chart-8/5">
                  <CardContent className="pt-8 pb-8 text-center">
                    ...
                    <CompleteStudyButton category="math" topicTitle={multiStepData.title} centered size="lg" />
                  </CardContent>
                </Card>
              </div>
            </div>
