...
import oneStepData from "@/data/one-step-equations.json"
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  <strong>Audience:</strong> {oneStepData.audience}
                </p>
                <CompleteStudyButton category="math" topicTitle={oneStepData.title} />
              </div>
            </div>
          </section>
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl sm:text-3xl font-bold text-foreground">Understanding One-Step Equations</h2>
                ...
                <div className="grid gap-4">
                  {oneStepData.kid_friendly_explainer.map((explanation, index) => (
              ...
              <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-6">
                  <Card className="border-chart-3/20">
                    <CardHeader>
                      <CardTitle className="text-xl text-primary">The Balance Scale Rule</CardTitle>
                      <CardDescription className="text-base">
                        <MathJax>{oneStepData.concept.kid_friendly_explanation}</MathJax>
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-4">
                        <div>
                          <p className="text-sm font-semibold text-foreground mb-2">Golden Rule:</p>
                          <p className="text-sm text-muted-foreground">
                            <MathJax>{oneStepData.concept.golden_rule}</MathJax>
                          </p>
                        </div>
                        <div>
                          <p className="text-sm font-semibold text-foreground mb-2">Inverse Operations:</p>
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            {oneStepData.concept.forms.map((form, idx) => (
                  ...
                  <Card className="border-chart-3/20">
                    ...
                    <CardContent>
                      <ul className="space-y-3">
                        {oneStepData.key_points.map((point, idx) => (
                        ...
                        <div className="space-y-3">
                          <label className="flex items-start gap-3 cursor-pointer group">
                            ...
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                              I understand the balance scale concept and why we do the same operation to both sides
                            </span>
                          </label>
                          <label className="flex items-start gap-3 cursor-pointer group">
                            <input
                            ...
                            />
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                              I know which inverse operations undo addition, subtraction, multiplication, and division
                            </span>
                          </label>
                          <label className="flex items-start gap-3 cursor-pointer group">
                            <input
                            ...
                            />
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                              I'm ready to see how these concepts work in practice
                            </span>
                          </label>
                        </div>
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  {oneStepData.step_by_step_examples.map((example) => (
          ...
          <section className="py-12 sm:py-16 lg:py-20 bg-muted/30">
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-4">
                  {oneStepData.teacher_notes.map((note, index) => (
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <p className="text-muted-foreground mb-6">
                  Master one-step equations with practice problems at different difficulty levels.
                </p>

                {/* Difficulty Selector and Print Button */}
                <div className="flex flex-wrap items-center gap-2 mb-8">
                  {Object.keys(oneStepData.exercises).map((difficulty) => (
                    <Button
                      key={difficulty}
                  ...
                  {oneStepData.exercises[selectedDifficulty as keyof typeof oneStepData.exercises] && (
                    <PrintExercisesButton
                      exercises={oneStepData.exercises[selectedDifficulty as keyof typeof oneStepData.exercises].items}
                      topicTitle={oneStepData.title}
                ...
                {oneStepData.exercises[selectedDifficulty as keyof typeof oneStepData.exercises] && (
                  <>
                    <Card className="mb-6 border-primary/20">
                      <CardContent className="pt-6">
                        <p className="text-sm text-muted-foreground">
                          <strong>Directions:</strong> <MathJax>{oneStepData.exercises[selectedDifficulty as keyof typeof oneStepData.exercises].directions}</MathJax>
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    {/* Practice Items */}
                    <div className="space-y-4">
                      {oneStepData.exercises[selectedDifficulty as keyof typeof oneStepData.exercises].items.map((item) => (
              ...
              <div className="mx-auto max-w-4xl">
                <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-chart-8/5">
                  <CardContent className="pt-8 pb-8 text-center">
                    ...
                    <CompleteStudyButton category="math" topicTitle={oneStepData.title} centered size="lg" />
                  </CardContent>
                </Card>
              </div>
            </div>
