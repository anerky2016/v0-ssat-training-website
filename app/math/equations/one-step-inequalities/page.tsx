...
import oneStepIneqData from "@/data/one-step-inequalities.json"
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-foreground mb-4">
                  {oneStepIneqData.title}
                </h1>
                <p className="text-lg text-muted-foreground mb-6">
                  <strong>Audience:</strong> {oneStepIneqData.audience}
                </p>
                <CompleteStudyButton category="math" topicTitle={oneStepIneqData.title} />
              </div>
            </div>
          </section>
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl sm:text-3xl font-bold text-foreground">Understanding One-Step Inequalities</h2>
                ...
                <div className="grid gap-4">
                  {oneStepIneqData.kid_friendly_explainer.map((explanation, index) => (
              ...
              <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-6">
                  <Card className="border-chart-3/20">
                    <CardHeader>
                      <CardTitle className="text-xl text-primary">What Are One-Step Inequalities?</CardTitle>
                      <CardDescription className="text-base">
                        <MathJax>{oneStepIneqData.concept.what_is_it}</MathJax>
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-4">
                        <div>
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            {oneStepIneqData.concept.symbols.map((symbol, idx) => (
                        ...
                        <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                          <p className="text-sm text-blue-900 dark:text-blue-200">
                            <MathJax>{oneStepIneqData.concept.kid_friendly_explanation}</MathJax>
                          </p>
                        </div>
                      </div>
                    </CardContent>
                  ...
                  <Card className="border-chart-3/20">
                    ...
                    <CardContent>
                      <ul className="space-y-3">
                        {oneStepIneqData.key_points.map((point, idx) => (
                  ...
                  <Card className="border-chart-3/20">
                    ...
                    <CardContent>
                      <ol className="space-y-3">
                        {oneStepIneqData.step_by_step.map((step, idx) => (
                          <li key={idx} className="flex items-start gap-3">
                        ...
                        <div className="space-y-3">
                          <label className="flex items-start gap-3 cursor-pointer group">
                            ...
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                              I understand that inequalities give me a range of answers, not just one number
                            </span>
                          </label>
                          <label className="flex items-start gap-3 cursor-pointer group">
                            <input
                            ...
                            />
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                              I know when to flip the inequality sign (when multiplying or dividing by a negative)
                            </span>
                          </label>
                          <label className="flex items-start gap-3 cursor-pointer group">
                            <input
                            ...
                            />
                            <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">
                              I'm ready to solve one-step inequalities and graph them on number lines
                            </span>
                          </label>
                        </div>
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  {oneStepIneqData.step_by_step_examples.map((example) => (
          ...
          <section className="py-12 sm:py-16 lg:py-20 bg-muted/30">
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-4">
                  {oneStepIneqData.teacher_notes.map((note, index) => (
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                ...
                <p className="text-muted-foreground mb-6">
                  Master one-step inequalities with practice problems at different difficulty levels.
                </p>

                {/* Difficulty Selector and Print Button */}
                <div className="flex flex-wrap items-center gap-2 mb-8">
                  {Object.keys(oneStepIneqData.exercises).map((difficulty) => (
                    <Button
                      key={difficulty}
                  ...
                  {oneStepIneqData.exercises[selectedDifficulty as keyof typeof oneStepIneqData.exercises] && (
                    <PrintExercisesButton
                      exercises={oneStepIneqData.exercises[selectedDifficulty as keyof typeof oneStepIneqData.exercises].items}
                      topicTitle={oneStepIneqData.title}
                ...
                {oneStepIneqData.exercises[selectedDifficulty as keyof typeof oneStepIneqData.exercises] && (
                  <>
                    <Card className="mb-6 border-primary/20">
                      <CardContent className="pt-6">
                        <p className="text-sm text-muted-foreground">
                          <strong>Directions:</strong> <MathJax>{oneStepIneqData.exercises[selectedDifficulty as keyof typeof oneStepIneqData.exercises].directions}</MathJax>
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    {/* Practice Items */}
                    <div className="space-y-4">
                      {oneStepIneqData.exercises[selectedDifficulty as keyof typeof oneStepIneqData.exercises].items.map((item) => (
              ...
              <div className="mx-auto max-w-4xl">
                <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-chart-8/5">
                  <CardContent className="pt-8 pb-8 text-center">
                    ...
                    <CompleteStudyButton category="math" topicTitle={oneStepIneqData.title} centered size="lg" />
                  </CardContent>
                </Card>
              </div>
            </div>
