...
import { BarChart3, ArrowLeft, BookOpen, Target, Zap, Clock } from "lucide-react"
...
export default function StatisticsPage() {
  return (
    <div className="min-h-screen">
      ...
      <main>
        {/* Hero Section */}
        <section className="py-16 sm:py-24 lg:py-32 bg-gradient-to-b from-chart-11/5 to-background">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-chart-11/10 text-chart-11">
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                {[
                  { title: "Mean, Median, Mode, Range", href: null },
                  { title: "Histograms", href: null },
                  { title: "Pie Graphs", href: null },
                  { title: "Probability", href: null }
                ].map((topic, index) => (
                  topic.href ? (
                      ...
                      <Card className="border-border bg-card hover:shadow-lg transition-all duration-300 transform hover:scale-105 cursor-pointer h-full">
                        <CardHeader className="pb-3">
                          <div className="flex items-center gap-3">
                            <div className="h-8 w-8 rounded-lg bg-chart-11/10 flex items-center justify-center">
                              <span className="text-chart-11 font-bold text-sm">{index + 1}</span>
                            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="grid gap-6 sm:gap-8 grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto">
              <Card className="border-border bg-card opacity-60 h-full">
                <CardHeader>
                  <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-chart-11/10 text-chart-11">
                  ...
                  <CardDescription className="text-muted-foreground">
                    Fun statistics problems with instant feedback
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-start gap-2">
                      <div className="mt-1.5 h-1.5 w-1.5 rounded-full bg-chart-11 flex-shrink-0" />
              ...
              <Card className="border-border bg-card opacity-60 h-full">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl text-card-foreground">
                    Statistics Tactics <span className="text-sm font-normal text-muted-foreground">(Coming Soon)</span>
                  </CardTitle>
                  <CardDescription className="text-muted-foreground">
                    Super strategies for statistics mastery
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2 text-sm text-muted-foreground">
