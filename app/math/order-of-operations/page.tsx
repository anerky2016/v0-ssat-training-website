...
import pemdas from "@/data/order-of-operations.json"
...
export default function OrderOfOperationsPage() {
  ...
  const exercisesByDifficulty = {
    easy: pemdas.exercises.easy || [],
    medium: pemdas.exercises.medium || [],
    challenge: pemdas.exercises.challenge || [],
    extreme: pemdas.exercises.extreme || [],
  }
  ...
  return (
    <MathJaxContext>
      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <p className="text-lg text-muted-foreground mb-4">
                <strong>Audience:</strong> {pemdas.audience}
              </p>
              <p className="text-base text-muted-foreground mb-6">
                {pemdas.summary}
              </p>
              <CompleteStudyButton category="math" topicTitle={pemdas.topic} />
            </div>
          </div>
        </section>

        {/* Concepts Sections */}
        {pemdas.concepts.map((concept, index) => (
        ...
        {/* Teaching Tips */}
        {pemdas.teaching_tips && pemdas.teaching_tips.length > 0 && (
                ...
                <Card className="border-chart-5/20">
                  <CardContent className="pt-6">
                    <ul className="space-y-3">
                      {pemdas.teaching_tips.map((tip, idx) => (
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="space-y-4">
                {pemdas.worked_examples.map((example, idx) => (
            ...
            <div className="mx-auto max-w-4xl">
              <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-chart-8/5">
                <CardContent className="pt-8 pb-8 text-center">
                  ...
                  <CompleteStudyButton category="math" topicTitle={pemdas.topic} centered size="lg" />
                </CardContent>
              </Card>
            </div>
          </div>
