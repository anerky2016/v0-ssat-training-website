...
export default function OrderingIntegersNumbersPage() {
  ...
  const exercisesByDifficulty = {
    easy: orderingData.exercises.easy || [],
    medium: orderingData.exercises.medium || [],
    challenge: orderingData.exercises.challenge || [],
    extreme: orderingData.exercises.extreme || [],
  }
  ...
  return (
    <MathJaxContext>
      ...
      <main>
        ...
        {/* Concepts Sections */}
        {orderingData.concepts.map((concept, index) => (
        ...
        {/* Teaching Tips */}
        {orderingData.teaching_tips && orderingData.teaching_tips.length > 0 && (
                ...
                <Card className="border-chart-5/20">
                  <CardContent className="pt-6">
                    <ul className="space-y-3">
                      {orderingData.teaching_tips.map((tip, idx) => (
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="space-y-4">
                {orderingData.worked_examples.map((example, idx) => (
