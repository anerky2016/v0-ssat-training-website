...
import similarityData from "@/data/similarity-ratios.json"
import { MathJaxContext, MathJax } from 'better-react-mathjax'
import { PrintExercisesButton } from "@/components/print-exercises-button"

export default function SimilarityRatiosPage() {
  ...
  const exercisesByDifficulty = {
    easy: similarityData.exercises.easy || [],
    medium: similarityData.exercises.medium || [],
    challenge: similarityData.exercises.challenge || [],
    extreme: similarityData.exercises.extreme || [],
  }
  ...
  return (
    <MathJaxContext>
      ...
      <main>
        {/* Hero Section */}
        <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-b from-chart-4/5 to-background">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-foreground mb-4">
                {similarityData.topic}
              </h1>
              <p className="text-lg text-muted-foreground mb-4">
                <strong>Audience:</strong> {similarityData.audience}
              </p>
              <p className="text-base text-muted-foreground">
                {similarityData.summary}
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Concepts Sections */}
        {similarityData.concepts.map((concept, index) => (
        ...
        {/* Teaching Tips */}
        {similarityData.teaching_tips && similarityData.teaching_tips.length > 0 && (
                ...
                <Card className="border-chart-5/20">
                  <CardContent className="pt-6">
                    <ul className="space-y-3">
                      {similarityData.teaching_tips.map((tip, idx) => (
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="space-y-4">
                {similarityData.worked_examples.map((example, idx) => (
                  <Card key={idx} className="border-chart-2/20">
                    <CardHeader>
                      <CardTitle className="text-lg">{example.title}</CardTitle>
                      {example.problem && (
                        <p className="text-sm text-muted-foreground mt-2">{example.problem}</p>
                      )}
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-4">
            ...
            <div className="mx-auto max-w-4xl">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                ...
                <PrintExercisesButton
                  ...
                  topicTitle={similarityData.topic}
