...
import gcfData from "@/data/greatest-common-factor.json"
import { MathJaxContext, MathJax } from 'better-react-mathjax'
import { PrintExercisesButton } from "@/components/print-exercises-button"

export default function GreatestCommonFactorPage() {
  ...
  const exercisesByDifficulty = {
    easy: gcfData.exercises.easy || [],
    medium: gcfData.exercises.medium || [],
    challenge: gcfData.exercises.challenge || [],
    extreme: gcfData.exercises.extreme || [],
  }
  ...
  return (
    <MathJaxContext>
      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <p className="text-lg text-muted-foreground mb-4">
                <strong>Audience:</strong> {gcfData.audience}
              </p>
        ...
        {/* Concepts Sections */}
        {gcfData.concepts.map((concept, index) => (
        ...
        {/* Teaching Tips */}
        {gcfData.teaching_tips && gcfData.teaching_tips.length > 0 && (
                ...
                <Card className="border-chart-5/20">
                  <CardContent className="pt-6">
                    <ul className="space-y-3">
                      {gcfData.teaching_tips.map((tip, idx) => (
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="space-y-4">
                {gcfData.worked_examples.map((example, idx) => (
