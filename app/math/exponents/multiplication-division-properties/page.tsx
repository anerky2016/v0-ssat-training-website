...
import { ArrowLeft, Lightbulb, Target, Sparkles, Info, BookOpen } from "lucide-react"
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="mx-auto max-w-4xl">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold text-foreground">Understanding Exponents</h2>
                </div>
