...
export default function RoundingDecimalsPage() {
  ...
  const exercisesByDifficulty = {
    easy: roundingData.exercises.easy || [],
    medium: roundingData.exercises.medium || [],
    challenge: roundingData.exercises.challenge || [],
    extreme: roundingData.exercises.extreme || [],
  }
  ...
  return (
    <MathJaxContext>
      ...
      <main>
        ...
        {/* Concepts Sections */}
        {roundingData.concepts.map((concept, index) => (
        ...
        {/* Teaching Tips */}
        {roundingData.teaching_tips && roundingData.teaching_tips.length > 0 && (
                ...
                <Card className="border-chart-5/20">
                  <CardContent className="pt-6">
                    <ul className="space-y-3">
                      {roundingData.teaching_tips.map((tip, idx) => (
                        <li key={idx} className="flex items-start gap-3">
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="space-y-4">
                {roundingData.worked_examples.map((example, idx) => (
            ...
            <div className="mx-auto max-w-4xl">
              ...
              <Card className="mb-6 border-chart-5/20">
                <CardHeader>
                  ...
                  <CardDescription>
                    <MathJax>{roundingData.exercises.instructions}</MathJax>
                  </CardDescription>
                </CardHeader>
              </Card>
