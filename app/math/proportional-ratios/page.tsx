...
import proportionsData from "@/data/proportional-ratios.json"
import { MathJaxContext, MathJax } from 'better-react-mathjax'
import { PrintExercisesButton } from "@/components/print-exercises-button"

export default function ProportionalRatiosPage() {
  ...
  const exercisesByDifficulty = {
    easy: proportionsData.exercises.easy || [],
    medium: proportionsData.exercises.medium || [],
    challenge: proportionsData.exercises.challenge || [],
    extreme: proportionsData.exercises.extreme || [],
  }
  ...
  return (
    <MathJaxContext>
      ...
      <main>
        {/* Hero Section */}
        <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-b from-chart-2/5 to-background">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-foreground mb-4">
                {proportionsData.topic}
              </h1>
              <p className="text-lg text-muted-foreground mb-4">
                <strong>Audience:</strong> {proportionsData.audience}
              </p>
              <p className="text-base text-muted-foreground">
                {proportionsData.summary}
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Concepts Sections */}
        {proportionsData.concepts.map((concept, index) => (
        ...
        {/* Teaching Tips */}
        {proportionsData.teaching_tips && proportionsData.teaching_tips.length > 0 && (
                ...
                <Card className="border-chart-5/20">
                  <CardContent className="pt-6">
                    <ul className="space-y-3">
                      {proportionsData.teaching_tips.map((tip, idx) => (
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="space-y-4">
                {proportionsData.worked_examples.map((example, idx) => (
            ...
            <div className="mx-auto max-w-4xl">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                ...
                <PrintExercisesButton
                  ...
                  topicTitle={proportionsData.topic}
