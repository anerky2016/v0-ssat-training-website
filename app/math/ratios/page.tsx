...
import { Percent, ArrowLeft, BookOpen, Target, Zap, Clock } from "lucide-react"
            ...
            <div className="grid gap-6 sm:gap-8 grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto">
              ...
              <Card className="border-border bg-card opacity-60 h-full">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl text-card-foreground">
                    Ratios Tactics <span className="text-sm font-normal text-muted-foreground">(Coming Soon)</span>
                  </CardTitle>
                  <CardDescription className="text-muted-foreground">
