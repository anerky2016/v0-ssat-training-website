...
import ratiosData from "@/data/simplifying-ratios.json"
import { MathJaxContext, MathJax } from 'better-react-mathjax'
import { PrintExercisesButton } from "@/components/print-exercises-button"

export default function SimplifyingRatiosPage() {
  ...
  const exercisesByDifficulty = {
    easy: ratiosData.exercises.easy || [],
    medium: ratiosData.exercises.medium || [],
    challenge: ratiosData.exercises.challenge || [],
    extreme: ratiosData.exercises.extreme || [],
  }
  ...
  return (
    <MathJaxContext>
      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <p className="text-lg text-muted-foreground mb-4">
                <strong>Audience:</strong> {ratiosData.audience}
              </p>
        ...
        {/* Concepts Sections */}
        {ratiosData.concepts.map((concept, index) => (
        ...
        {/* Teaching Tips */}
        {ratiosData.teaching_tips && ratiosData.teaching_tips.length > 0 && (
                ...
                <Card className="border-chart-5/20">
                  <CardContent className="pt-6">
                    <ul className="space-y-3">
                      {ratiosData.teaching_tips.map((tip, idx) => (
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="space-y-4">
                {ratiosData.worked_examples.map((example, idx) => (
