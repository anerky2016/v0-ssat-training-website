...
import { BookOpen, Brain, ListChecks, Sparkles, Award, FileText } from "lucide-react"
              ...
              <Link href="/vocabulary/sentence-completion">
                <Card className="border-border bg-card hover:shadow-lg transition-shadow cursor-pointer h-full">
                  <CardHeader>
                    ...
                    <CardTitle className="text-xl text-card-foreground">Sentence Completion</CardTitle>
                    <CardDescription className="text-muted-foreground">
                      Practice fill-in-the-blank vocabulary questions
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li className="flex items-start gap-2">
                        ...
                        <span>100 Chapter 2 questions</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="mt-1.5 h-1.5 w-1.5 rounded-full bg-teal-500 flex-shrink-0" />
