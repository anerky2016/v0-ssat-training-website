...
www.midssat.com
      ...
      // If SMTP authentication fails or email sending fails, log the feedback instead
      console.warn('⚠️  SMTP error, logging feedback instead:', emailError.message)
      console.log('📝 Feedback logged:')
      console.log('  To:', recipientEmail)
      console.log('  From:', displayName, replyToEmail ? `<${replyToEmail}>` : '(anonymous)')
