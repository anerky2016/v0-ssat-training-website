...
// Level configuration
const levels = [
  { level: 3, ageRange: '6-7', file: 'wordly-wise-level-3.json', maxTokens: 150 },
  { level: 4, ageRange: '7-8', file: 'wordly-wise-level-4.json', maxTokens: 200 },
  { level: 5, ageRange: '8-9', file: 'wordly-wise-level-5.json', maxTokens: 250 },
  { level: 6, ageRange: '10-11', file: 'wordly-wise-level-6.json', maxTokens: 300 },
  { level: 7, ageRange: '11-12', file: 'wordly-wise-level-7.json', maxTokens: 350 },
];
...
async function processAllLevels() {
  console.log(`🚀 Starting synonyms and antonyms generation for Levels 3-7\n`);
