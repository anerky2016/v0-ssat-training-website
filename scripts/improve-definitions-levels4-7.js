...
// Level configuration - levels 4, 5, 6, and 7
const levels = [
...
Example for ages 7-8: "To do something successfully, like finishing a puzzle or winning a game."
...
async function processAllLevels() {
  console.log(`🚀 Starting definition improvement for Levels 4-7\n`);
