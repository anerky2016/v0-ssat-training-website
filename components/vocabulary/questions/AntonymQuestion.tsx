...
export interface AntonymQuestionData {
  id: string
  question: string
  options: string[]
  answer: string
...
interface AntonymQuestionProps {
  question: AntonymQuestionData
  onAnswer?: (isCorrect: boolean) => void
  showFeedback?: boolean
}

export function AntonymQuestion({
  question,
  onAnswer,
  showFeedback = true
    ...
    <Card className="border-l-4 border-l-orange-500">
      <CardHeader>
        <div className="flex items-start gap-2">
          <div className="px-2 py-1 bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 text-xs font-semibold rounded">
            ANTONYM
          </div>
        </div>
